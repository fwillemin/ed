...
<div class="form-group">
    <label for="addMaquetteDateCreation" class="col-sm-4 control-label">Date du RDV</label>
    <div class="col-sm-5">
...
<div class="form-group">
    <label for="addMaquetteClientText" class="col-sm-4 control-label">Client</label>
    <div class="col-sm-7">
        ...
        <select name="addMaquetteClientId" id="addMaquetteClientId" class="form-control" title="Choisir un client" required >
...
<div class="form-group">
    <label for="addMaquetteDateLimite" class="col-sm-4 control-label">Date limite</label>
    <div class="col-sm-5">
...
<div class="form-group">
    <label for="addMaquetteDescription" class="col-sm-4 control-label">Description</label>
    <div class="col-sm-8">
...
<div class="form-group">
    <label for="addMaquetteDifficulte" class="col-sm-4 control-label">Difficulté</label>
    <div class="col-sm-5">
...
<div class="form-group">
    <label for="addMaquettePathFiles" class="col-sm-4 control-label">Emplacement fichiers</label>
    <div class="col-sm-8">
