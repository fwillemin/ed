...
class TCPDF {
	 ...
	 */
	public function __construct($orientation='P', $unit='mm', $format='A4', $unicode=true, $encoding='UTF-8', $diskcache=false, $pdfa=false, $infoSociete1 = 'Renseignez ces informations', $infoSociete2 = 'Renseignez ces informations') {
		/* Set internal character encoding to ASCII */
		if (function_exists('mb_internal_encoding') AND mb_internal_encoding()) {
			$this->internal_encoding = mb_internal_encoding();
			mb_internal_encoding('ASCII');
		}
                //initialisation des données société
                $this->infoSocieteLigne1 = $infoSociete1;
                $this->infoSocieteLigne2 = $infoSociete2;
	...
	public function Footer() {
        ...
        // Page number
        $this->writeHTMLCell(0, 0, '', '', $this->infoSocieteLigne1 . '' . $this->infoSocieteLigne2, 0, 1, 0, true, '', true);
        //$this->Cell(0, 10, $this->infoSocieteLigne1, 0, false, 'C', 0, '', 0, false, 'T', 'M');                
        //$this->Cell(0, 10, $this->infoSocieteLigne2, 0, false, 'C', 0, '', 0, false, 'T', 'M');
