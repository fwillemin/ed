...
//    });
    ...
    $('#modFactureEcheancePaiement').on('change', function(){
        $.post(chemin + 'facturation/modEcheanceFacture', {factureId:$(this).attr('data-factureid'), echeanceId: $(this).val()}, function(retour){
            switch (retour.type) {
                case 'success':
                    window.location.reload();
                    break;
